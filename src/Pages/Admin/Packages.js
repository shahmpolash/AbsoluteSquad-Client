  ...
  return (
    <div>
      ...
      <BackToAdminDashboard></BackToAdminDashboard>
        ...
        <h3>Package For Onetime Payment</h3>
        <table className="rwd-table">
          ...
          <tbody>
            ...
            {packages.map((item, index) => item.featureTen === 'Fixed' && (
              <tr key={item._id}>
        ...
        <h3>Package For Monthly Payment</h3>
        <div class="col-sm mb-15">
        ...
        <table className="rwd-table">
          ...
          <tbody>
            ...
            {packages.map((item, index) => item.featureTen === 'Monthly' &&(
              <tr key={item._id}>
                <td data-th="SL No.">{index + 1}</td>
                <td data-th="Package Name">{item.packageName}</td>
                <td data-th="Price">{item.price}$</td>
